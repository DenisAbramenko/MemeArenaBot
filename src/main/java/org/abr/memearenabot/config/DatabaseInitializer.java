...
public class DatabaseInitializer implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        try {
            ...
            jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS memes (" +
                    "id BIGSERIAL PRIMARY KEY," +
                    "url VARCHAR(255) NOT NULL," +
                    "likes INTEGER NOT NULL DEFAULT 0," +
                    "created_at TIMESTAMP NOT NULL DEFAULT NOW()," +
                    "in_contest BOOLEAN NOT NULL DEFAULT false," +
                    "published_to_feed BOOLEAN NOT NULL DEFAULT false," +
                    "type VARCHAR(255) NOT NULL DEFAULT 'TEMPLATE_BASED'," +
            ...
            jdbcTemplate.execute("CREATE TABLE IF NOT EXISTS users (" +
                    ...
                    "total_memes INTEGER NOT NULL DEFAULT 0," +
