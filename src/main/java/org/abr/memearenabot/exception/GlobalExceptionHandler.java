...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<Object> handleMemeGenerationException(MemeService.MemeGenerationException ex,
                                                                WebRequest request) {
    ...
    public ResponseEntity<Object> handleBotRegistrationException(BotConfig.BotRegistrationException ex,
                                                                 WebRequest request) {
